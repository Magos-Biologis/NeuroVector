...
The last model that this project will present is the Wilson model. This is like the Hodgkin-Huxley model also four-dimensional, however, it only requires 180 floating point operations per millisecond. It is not biophysically relevant \cite{izhikevich2004model}
