...
The original values for the constants are \(a=0.7\), \(b=0.8\), and \(\phi=0.08\) \cite{Sherwood2013}. For these values, the \glspl{gls:nullcline} look like \Cref{fig:nullclines-original}. 
