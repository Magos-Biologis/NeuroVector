...
As can be seen in \Cref{fig:nullclines-original} there is only one \gls{gls:equilibrium}. This is located at \((-1.1994, -0.62426)\). This is a \gls{gls:spiral}. 

It is also possible for the model to have three \glspl{gls:equilibrium}. This is for example the case if \(b\) is changed to \(-0.8\). This can be seen in \Cref{fig:nullclines-negative}.
