...
Mathematically, the flow of current is represented as the change in voltage over time scaled by capacitance:
    \begin{equation}
       ...
       \end{equation}
       and recall that the current through a given \gls{gls:ionChan}, \cref{eq:ionCurrent}, is the product of that channel's \gls{gls:contan} and the \gls{gls:rPote} for the specific ion
    \begin{equation}
...
\begin{sysEquation}[HodHuxSys]
    ...
    \ode{n} &= \quad \frac{n_\infty\br{\unit{\V\membrane}}-n}{\tau\nn\br{\unit{\V\membrane}}} \quad &&=\alpha\nn \br{\unit{\V\membrane}} \br{1-n} - \beta\nn \br{\unit{\V\membrane}} n &&\\
    \ode{m} &= \quad \frac{m_\infty\br{\unit{\V\membrane}}-m}{\tau\mm\br{\unit{\V\membrane}}} \quad &&=\alpha\mm \br{\unit{\V\membrane}} \br{1-m} - \beta\mm \br{\unit{\V\membrane}} m &&\\
    \ode{h} &= \quad \frac{h_\infty\br{\unit{\V\membrane}}-h}{\tau\hh\br{\unit{\V\membrane}}} \quad &&=\alpha\hh \br{\unit{\V\membrane}} \br{1-h} - \beta\hh \br{\unit{\V\membrane}} h &&
\end{sysEquation}
