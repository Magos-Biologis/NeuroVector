...
H\&H presented the model as a set of four\anakintodo{Make it more clear that they're `emulating' stochasticity} inter-dependent \glspl{ode} with respect to time.
