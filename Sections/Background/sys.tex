...
\section{Scale of model}
 ...
 In scaling processes the complexity of a system will often change. In the description of neuronal dynamics some single-neuron models are highly detailed and incorporate sub-cellular organelles such as mitochondria or take into account the morphology of the dendritic and axonal tree.
 
 to a network level some kind of middle-ground in complexity will have to be reached. To describe ...
