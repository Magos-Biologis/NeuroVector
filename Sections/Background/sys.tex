...
\begin{eqSystem}\label{eq:HodHuxSys}
    C_m \ode{V_m}{t} &= I_m - \br{\bar{g}_\rmm{K} n^4 \br{V_m - V_\rmm{K}} + \bar{g}_\rmm{Na} m^3 h \br{V_m - V_\rmm{Na}}  + \bar{g}_\rmm{L} \br{V_m - V_\rmm{L}}} \\
...
\begin{table}[htb]
    ...
    \begin{tabular}{p{0.20\textwidth}p{0.20\textwidth}p{0.20\textwidth}}\hline
