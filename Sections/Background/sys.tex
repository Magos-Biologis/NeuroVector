...
\section{Scale of model}
 ...
 In scaling processes the complexity of a system will often change. In the description of neuronal dynamics  from single-neuron level to a network level some kind of middle-ground in complexity will have to be reached. To describe ...
...
Microscopic, mesoscopic and macroscopic models represent three distinct approaches to describing the behavior of systems at varying scales. For better understanding, we're going to analyze all of them respectively. The main distinction between those scales of models is the size of the date they describe.

\begin{enumerate}

  \item \textbf{Microscopic} models

  \item \textbf{Mesoscopic} models

  \item \textbf{Macroscopic} models
