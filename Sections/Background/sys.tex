...
When describing a network level model some kind of middle ground in complexity will have to be reached. The network model include many cells interacting with each other a
