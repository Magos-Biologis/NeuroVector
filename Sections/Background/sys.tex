...
\subsection{Chay}
In 1985, T.R. Chay proposed a model of three-dimensional nonlinear differential equations based on the \gls{hh} model to study chaotic behavior and show ionic events in excitable membranes. 
