...
\begin{figure}[ht]
    ...
    \caption{The \gls{gls:circuit diagram} of the Hodgkin-Huxley model~\cite{HodHux1952}.}\label{fig:HHcircuit}
\end{figure}
There are five elements to this \gls{gls:circuit diagram}. These are the \gls{gls:batteries}, \gls{gls:capacitor}, \gls{gls:resistor}, \gls{gls:variable resistors}, and \gls{gls:wires}. 
