...
\begin{tikzpicture}[
    ...
    \begin{scope}[line width = 1.0pt, line cap = rect]   
        ...
        \draw ($(TL)!13/24!(TR)$) -- ++(0,0.75) node[scale = 0.5,circle,draw,fill = white] {\footnotesize $Outside$}
              ($(BL)!13/24!(BR)$) -- ++(0,-0.75) node[scale = 0.5,circle,draw,fill = white] {\footnotesize $Inside$};
